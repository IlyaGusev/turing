...
with open(os.path.join(models_dir, "vectorizers_4d.pkl"), "rb") as f:
...
with open(os.path.join(models_dir, "mryab_stregr_a_4.pkl"), "rb") as file:
    stregr_a = pickle.load(file)

with open(os.path.join(models_dir, "mryab_stregr_b_4.pkl"), "rb") as file:
...
subm.to_csv("../submitions/answer-C.csv")
